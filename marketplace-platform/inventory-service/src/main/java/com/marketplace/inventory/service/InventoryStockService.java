...
public class InventoryStockService {
    ...
    /**
     * Reserves stock using optimistic locking: if two concurrent requests conflict,
     * one gets an OptimisticLockingFailureException and returns false instead of overselling.
     */
